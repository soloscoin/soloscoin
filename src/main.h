...
static const int64 MAX_MONEY = 2000000000 * COIN;			// 100 mil
...
static const uint256 hashGenesisBlockOfficial("0xe16323ec45d64d411aaf4ddbf4c552d75bccc6b5863488e722713b4ad3a26374");
static const uint256 hashGenesisBlockTestNet ("0xe16323ec45d64d411aaf4ddbf4c552d75bccc6b5863488e722713b4ad3a26374");
...
public:
    ...
    {
        // soloscoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // soloscoin: get transaction coin age
...
public:
    ...
    // soloscoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // soloscoin: entropy bit for stake modifier if chosen by modifier
    ...
    // soloscoin: two types of block: proof-of-work or proof-of-stake
    ...
    // soloscoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // soloscoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // soloscoin: trust score of block chain
    int nHeight;

    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // soloscoin: block index flags
    enum
    {
